...
from nec_portal.dashboards.project.links import tables as links_tables
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'project/links/index.html'
    ...
    def get_context_data(self, **kwargs):
        ...
        link_list = self._get_project_links()
    ...
    def _get_project_links(self):
        return getattr(nec_portal_settings, 'PROJECT_LINKS', {})
