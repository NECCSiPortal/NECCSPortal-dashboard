...
from nec_portal.dashboards.project.history import views

INDEX_URL = reverse("horizon:project:history:index")


class HistoryTest(test.TestCase):
    ...
    def test_search_dispatch(self):
        ...
        view.PROJECT_HISTORY_FRAME = "PROJECT_HISTORY_FRAME"
