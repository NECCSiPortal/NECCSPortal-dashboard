...
class BrowserTests(test.SeleniumTestCase):
    """This test will output the capture of capacity management."""
    ...
    def admin_capacity(self):
        ...
        self.trans_and_wait(
            'capacity_group_tabs__capacity',
            '/admin/capacity/?tab=capacity_group_tabs__capacity')
        ...
        # Capture the initial display
        self.trans_and_wait(
            'capacity_group_tabs__capacity_az',
            '/admin/capacity/?tab=capacity_group_tabs__capacity_az')
        time.sleep(SET_DASHBOARD_LOADING_WAIT)  # dashboard loading time
        self.save_screenshot()

        # * Capacity by host Tab * #
        # Capture the initial display
        self.trans_and_wait(
            'capacity_group_tabs__capacity_host',
            '/admin/capacity/?tab=capacity_group_tabs__capacity_host')
        time.sleep(SET_DASHBOARD_LOADING_WAIT)  # dashboard loading time
        self.save_screenshot()
